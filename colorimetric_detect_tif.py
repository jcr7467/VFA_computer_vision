...
template_dictionary = {
    'template_A': 'alignment_A_color.tif',
    'template_B': 'alignment_B_color.tif',
    'template_C': 'alignment_C_color.tif',
    'template_D': 'alignment_D_color.tif'
}
...
def averagesOfAllImages(displayCirclesBool = False):
    ...
    i = 0
    matrix = np.ones(NUMBER_OF_SPOTS + 1)
...
def main():
    ...
    #best_guess_boundaries("colorimetric_tiff/20200526_180412.tif", template_dictionary)
