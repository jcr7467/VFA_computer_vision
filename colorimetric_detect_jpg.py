...
template_dictionary = {
    'template_A': 'alignment_A_color.jpg',
    'template_B': 'alignment_B_color.jpg',
    'template_C': 'alignment_C_color.jpg',
    'template_D': 'alignment_D_color.jpg'
}
...
def findAllCircleAveragesFor(imagePath, image_name, displayCirclesBool):
    ...
    aligned_image = aligned_image[:, :, 1] #Green channel for colorimetric
    cv2.imshow("Test", aligned_image)
    cv2.imwrite("greenchannel.jpg", aligned_image)
...
def main():
    ...
    #best_guess_boundaries("jpegcolor/20200526_183129.jpg", template_dictionary)
    cv2.waitKey(0)
